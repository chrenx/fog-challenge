...
def get_time_embedding(time_steps, t_emb_dim):
    ...
    :param t_emb_dim: Dimension of the embedding
...
class DownBlock(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, t_emb_dim, 
        num_heads, num_layers, norm_channels,
        down_sample, attn, 
        cross_attn=False,  # for conditioned latent diffusion
        context_dim=None,  # for conditioned latent diffusion
    ):
        super().__init__()
